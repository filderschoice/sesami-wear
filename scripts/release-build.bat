@echo off
rem リリースビルド(署名付きAAB)を実行するバッチファイル(BL-035、BL-093)。
rem スマホ用(mobile)とウォッチ用(wear)の2つのAABをまとめてビルドする。
...
rem 例: release-build.bat -VersionCode 10 -WearVersionCode 1010 -VersionName 1.1.0
