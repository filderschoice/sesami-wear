...
| [images/screenshots/](images/screenshots/) | スマートフォン用2枚・Wear OS用5枚 | スクリーンショット |
...
| `wear_4_unlock_confirm.png` | 解錠時の確認画面（キャンセル／全解錠） | 384x384 |
| `wear_5_device_select.png` | 操作対象デバイスの選択画面 | 384x384 |
