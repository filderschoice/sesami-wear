...
- id: BL-097
  ...
  タスク内容: 2成果物・2トラック構成でのPlay配信を実機で確認する。2026-09-06時点で以下を
    ...
    あわせて確認する。なお2026-09-06のデバッグビルドでの実機確認により、Complicationの表示と
    タップでのデバイス変更、タイルの操作ラベル・デバイス変更チップの表示、システムバーの
    視認性、施錠/解錠の動作はいずれも確認済み。残るのはPlay配信版での再確認と、BL-104で
    短縮した混在状態の状態ラベル「一部解錠」が省略なく表示されることの確認
  優先度: P3
  状態: 未着手
  担当: ユーザー
